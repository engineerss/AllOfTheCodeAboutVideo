...
@implementation ZSRecordEncoder
...
//ZSRecordEncoder遍历构造器的
+ (ZSRecordEncoder*)encoderForPath:(NSString*) path Height:(NSInteger) cy width:(NSInteger) cx channels: (int) ch samples:(Float64) rate {
    ZSRecordEncoder* enc = [ZSRecordEncoder alloc];
