...
#import "ZSRecordVideoVC.h"
#import "ZSRecordEngine.h"
...
@interface ZSRecordVideoVC ()<ZSRecordEngineDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
...
@property (weak, nonatomic) IBOutlet ZSRecordProgressView *progressView;

@property (strong, nonatomic) ZSRecordEngine         *recordEngine;
...
@implementation ZSRecordVideoVC
...
- (ZSRecordEngine *)recordEngine {
    if (_recordEngine == nil) {
        _recordEngine = [[ZSRecordEngine alloc] init];
...
#pragma mark - ZSRecordEngineDelegate
