...
- (void)LiveInit:(NSURL*)rtmpUrl Preview:(UIView*)previewView{
    if (self) {
        ...
        _livesession = [[VCSimpleSession alloc] initWithVideoSize:CGSizeMake(LIVE_VIDEO_DEF_WIDTH, LIVE_VIDEO_DEF_HEIGHT) frameRate:LIVE_VIDEO_DEF_FRAMERATE bitrate:LIVE_VIDEO_DEF_BITRATE useInterfaceOrientation:YES originView:nil];
